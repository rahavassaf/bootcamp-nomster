...
ActiveRecord::Schema.define(version: 2019_06_11_020834) do
  ...
  create_table "likes", force: :cascade do |t|
    ...
    t.index ["user_id", "place_id"], name: "index_likes_on_user_id_and_place_id"
  ...
  create_table "places", force: :cascade do |t|
    ...
    t.float "latitude"
    t.float "longitude"
    t.index ["id"], name: "index_places_on_id"
